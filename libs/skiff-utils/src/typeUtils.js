...
exports.filterTruthy = exports.filterExists = exports.ifMapHas = exports.assertUnreachable = exports.assert = exports.assertExists = void 0;
...
const assertUnreachable = (object, message = 'Did not expect to get here') => {
